...
* [随机选择工具](https://apps.microsoft.com/detail/9N2S39RTRPB6)
   ![Static Badge](https://img.shields.io/badge/WPF-Free-darkgreen?logo=microsoftstore)

  [随机选择工具PWA](https://apps.microsoft.com/detail/9PMKD8SSQZH7)
  ![Static Badge](https://img.shields.io/badge/PWA-Free-darkgreen?logo=microsoftstore)
...
* [猜词游戏](https://apps.microsoft.com/detail/9NLX9V1X4MRL)
   ![Static Badge](https://img.shields.io/badge/WPF-Free-darkgreen?logo=microsoftstore)

   [猜词游戏PWA](https://apps.microsoft.com/detail/9N61ZN52ZCWC)
   ![Static Badge](https://img.shields.io/badge/PWA-Free-darkgreen?logo=microsoftstore)
...
* [扫雷](https://apps.microsoft.com/detail/9NCS89MQ8P5N)
   ![Static Badge](https://img.shields.io/badge/WPF-Free-darkgreen?logo=microsoftstore)
  
  A classic minesweeper game that offers three styles and supports custom amounts
* [数织](https://apps.microsoft.com/detail/9NP8GH864JTW)
   ![Static Badge](https://img.shields.io/badge/WPF-Free-darkgreen?logo=microsoftstore)
  
  A Nonograms with random levels and hundreds of predefined levels

  [数织 解题版](https://apps.microsoft.com/detail/9P9938FPD2MM)
   ![Static Badge](https://img.shields.io/badge/WPF-blue?logo=microsoftstore)
