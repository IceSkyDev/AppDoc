...
---
* 1.3.2
  * 几何路径查看器增加计算路径长度及中心点功能，支持路径缩小并自动调整位置
  * 列表操作查找增加是否区分大小写选项
  * 十六进制编辑器增加设置字节数及字节序交换方式
  * 文本转图片增加背景图设置
  * 图片像素化复制颜色问题修复
* 1.3.1
  * 增加文本转图片功能，可以将富文本转换为图片文件
  * 增加查看字体文件中字符功能，支持ttf和otf文件
  * 几何路径增加缩放、旋转和翻转功能
  * 文件名复制时可选是否包括后缀
  * 界面优化增强
* 1.3.0
  * 增加根据文本生成Identicon和Jdenticon功能
  * 增加批量转换图片尺寸功能，包含预定义尺寸集合
  * Gif创建功能增加循环、默认延迟、背景等更多选项
* 1.2.10
  * 日期计算中阴历增加八字转换
  * 年历增加阴历显示开关
  * 摩斯编码增加符号配置
